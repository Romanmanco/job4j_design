...
values ('apple', 150), ('samsung', 125), ('huawei', 105), ('nokia', 5001);
select * from devices;
...
insert into devices_people(people_id, device_id) values (2, 2), (2, 2), (2, 2);
insert into devices_people(people_id, device_id) values (3, 1), (3, 3), (3, 3);
